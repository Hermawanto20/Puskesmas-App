...
async function simpanUser() {
  ...
  try {
    const namaDokter = document.getElementById('nama-dokter-user').value.trim() || null;
...
async function editUser(id) {
  ...
  document.getElementById('nama-dokter-user').value = data.nama_dokter || '';
...
const namaDokter = document.getElementById('nama-dokter-user').value.trim() || null;
   ...
   .update({ nama, username, password, role, nama_dokter: namaDokter })
...
function resetFormUser() {
  ...
  document.getElementById('nama-dokter-user').value = '';
  window.editUserId = null;
